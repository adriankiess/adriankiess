...
<ol type="A">
    <li>
    <a href="//github.com/adriankiess/adriankiess/raw/main/anschreiben-grundbegriffe-des-mind-control-in-zwanzig-sprachen-v4-2.txt" target="_blank">Anschreiben Grundbegriffe des Mind-Control in zwanzig Sprachen V4.2 (jetzt mit Begleitschreiben)</a> (TXT Dokument / document)
    </li>
    <li>
